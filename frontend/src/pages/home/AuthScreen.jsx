		...
		<div className='hero-bg relative'>
			...
			<svg viewBox="0 0 1000 100" preserveAspectRatio="none" className="w-full">
				<defs>
					...
					{/* Gradient untuk stroke pink yang dimodifikasi */}
					<linearGradient id="pinkGradientStroke" x1="0%" y1="0%" x2="100%" y2="0%">
					<stop offset="0%" stopColor="#e91e63" stopOpacity="0.2" /> {/* Tambahkan sedikit opasitas di awal */}
					<stop offset="50%" stopColor="#e91e63" />
					<stop offset="100%" stopColor="#e91e63" stopOpacity="0.2" /> {/* Tambahkan sedikit opasitas di akhir */}
					</linearGradient>
				</defs>

				{/* Stroke pink dengan gradasi yang dimodifikasi */}
				<path
